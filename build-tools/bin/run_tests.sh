...
function start_dos_test() {
  ...
  pushd "${ROOT_DIR}/test" > /dev/null
  ${jdk_dir}/bin/java  -cp log4j-core-2.12.1.jar:log4j-api-2.12.1.jar:. -Dlog4j2.configurationFile=${ROOT_DIR}/src/test/resources/log4j-vuln2.properties -javaagent:${agent_jar} Vuln2 > /tmp/vuln2.log &
...
${JDK_DIR}/bin/javac -cp log4j-core-2.12.1.jar:log4j-api-2.12.1.jar Vuln2.java
popd > /dev/null
